...
export default function Integrations2() {
  return (
    <div className="theme-transition w-full bg-black py-16">
      <div className="mx-auto max-w-6xl px-6">
        <div className="theme-accent-border grid grid-flow-row-dense grid-cols-2 gap-px overflow-hidden rounded-none border bg-[var(--theme-accent-soft)] sm:grid-cols-3 md:grid-cols-6 lg:grid-cols-4">
          ...
          <div className="bg-muted/50 relative col-span-2 row-span-2 flex flex-col items-center justify-center overflow-hidden p-6 text-center shadow-[inset_0_0px_10px_2px_rgba(0,0,0,0.15)] sm:col-span-3 md:col-span-6 lg:col-span-2 dark:shadow-[inset_0_0px_10px_2px_rgba(0,0,0,0.5)]">
            ...
            <div className="relative z-10">
              <h3 className="theme-accent mb-5 max-w-[260px] text-lg leading-snug font-medium sm:text-xl">
