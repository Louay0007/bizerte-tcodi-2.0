...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      "--inner-gradient": isActive
        ? "linear-gradient(145deg, #60496e8c 0%, #71C4FF44 100%)"
        : "linear-gradient(145deg, rgba(80,80,80,0.3) 0%, rgba(40,40,40,0.5) 100%)",
      "--behind-glow-color": "transparent",
      "--behind-glow-size": "50%",
      "--pointer-x": "50%",
      "--pointer-y": "50%",
      ...
      "--sunpillar-1": isActive
        ? "hsl(2, 100%, 73%)"
        : "hsl(0, 0%, 50%)",
      "--sunpillar-2": isActive
        ? "hsl(53, 100%, 69%)"
        : "hsl(0, 0%, 45%)",
      "--sunpillar-3": isActive
        ? "hsl(93, 100%, 69%)"
        : "hsl(0, 0%, 40%)",
      "--sunpillar-4": isActive
        ? "hsl(176, 100%, 76%)"
        : "hsl(0, 0%, 45%)",
      "--sunpillar-5": isActive
        ? "hsl(228, 100%, 74%)"
        : "hsl(0, 0%, 50%)",
      "--sunpillar-6": isActive
        ? "hsl(283, 100%, 73%)"
        : "hsl(0, 0%, 45%)",
  ...
  const shineStyle = {
    maskImage:
      "repeating-conic-gradient(from 0deg, #000 0deg 60deg, transparent 60deg 360deg)",
    maskMode: "luminance" as const,
    maskRepeat: "repeat" as const,
    maskSize: "150%",
    maskPosition: `top calc(200% - (var(--background-y) * 5)) left calc(100% - var(--background-x))`,
    filter: isActive
      ? "brightness(0.66) contrast(1.33) saturate(0.33) opacity(0.5)"
      : "brightness(0.66) contrast(1.33) saturate(0) opacity(0.3)",
  ...
  return (
    <div
      ref={wrapRef}
      className={`relative touch-manipulation ${className}`.trim()}
      style={
        {
          perspective: "500px",
                ...
                <h3
                  ...
                  style={{
                    ...
                    backgroundImage: isActive
                      ...
                      : "linear-gradient(to bottom, #fff, #888)",
                ...
                <p
                  ...
                  style={{
                    ...
                    backgroundImage: isActive
                      ...
                      : "linear-gradient(to bottom, #ccc, #777)",
                    backgroundSize: "1em 1.5em",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
                    WebkitBackgroundClip: "text",
